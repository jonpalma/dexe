				...
				<div class="item active">
					<div class="carousel-caption center-block">
						<div class="col-xs-4 img-spacing">
							<a data-toggle="lightbox" data-gallery="multiimages" href="img/victoria/01.jpg"><img class="img-responsive center-block" src="img/victoria/1.jpg" alt=""></a>
						</div>
						<div class="col-xs-4 img-spacing">
							<a data-toggle="lightbox" data-gallery="multiimages" href="img/victoria/02.jpg"><img class="img-responsive center-block" src="img/victoria/2.jpg" alt=""></a>
						</div>
						<div class="col-xs-4 img-spacing">
		...
		<div class="container center">
			...
			<div class="row models-container">
				<div class="col-sm-4">
					...
					<a class="center-block purple-btn" href="modelos/cambridge.php">Ver Modelo</a>
				</div>
				<div class="col-sm-4">
				...
				<div class="col-sm-4">
					...
					<a class="center-block orange-btn" href="modelos/sheffield.php">Ver Modelo</a>
				</div>
			</div>
		</div>
	</div>
