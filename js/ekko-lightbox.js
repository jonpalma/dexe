...
(function() {
  ...
  EkkoLightbox = function(element, options) {
    ...
    $(document.body).append('<div id="' + this.modal_id + '" class="ekko-lightbox modal fade" tabindex="-1"><div class="modal-dialog"><div class="modal-content">' + header + '<div class="modal-body"><button type="button" class="close" id="modal-close" data-dismiss="modal" aria-hidden="true">&times;</button><div class="ekko-lightbox-container"><div></div></div></div>' + footer + '</div></div></div>');
  ...
  EkkoLightbox.prototype = {
    ...
    showLoading: function() {
      this.lightbox_body.html( '<div class="loader">Loading...</div>' ); //'<div class="modal-loading">' + this.options.loadingMessage + '</div>');
      return this;
    },
