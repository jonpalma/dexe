...
<div class="wrapper fraccionamiento alcantara">

	<div class="banner"></div>

	<div class="light-spacing main-header">
		<div class="container text-center">
			<h1 class="title white">PUENTE DE PIEDRA</h1>
			<div class="col-sm-2">
	...
	<div class="modelos spacing" id="modelos">
		<div class="container center">
			...
			<div class="row models-container">
				<div class="col-sm-6">
					<img class="no-drag" src="img/index/modelos/purple.png" alt="C'ADIZ">
					<h2 class="title purple">CÁDIZ</h2>
					<p class="text-content">Terreno 120 m² / Const. 123 m²</p>
					<a class="center-block purple-btn" href="pdf/alcantara/cadiz.pdf" target="_blank">Ver PDF</a>
				</div>
				<div class="col-sm-6">
					<img class="no-drag" src="img/index/modelos/orange.png" alt="VIGO">
					<h2 class="title orange">VIGO</h2>
					<p class="text-content">Terreno 120 m² / Const. 153 m²</p>
					<a class="center-block orange-btn" href="pdf/alcantara/vigo.pdf" target="_blank">Ver PDF</a>
				</div>
			</div>
		</div>
	</div>
...
<h1 class="title green">VIDEO</h1>
<div class="video-container">
<img href="#video-modal" data-toggle="modal" data-target="#video-modal" class="" src="img/index/icons/play.png" alt="Play">
</div>
</div>
...
<!-- VIDEO -->
	...
	<div class="map" fracc="alcantara">
		<a href="https://www.google.com.mx/maps/place/28%C2%B038'55.8%22N+106%C2%B008'59.9%22W/@28.6488407,-106.1521457,17z/data=!3m1!4b1!4m2!3m1!1s0x0:0x0" target="_blank">
			<img src="img/puente/map/map.jpg" alt="Mapa">
		</a>
	</div>
</div>
